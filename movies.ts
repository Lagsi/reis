export const movies = [
  {
    ...
    cast: ["Dilan Aksüt", "Sabri Tutal", "İlyas Salman", "Mayşeker Yücel"],
    synopsis:
      "After a wedding ceremony for an arranged marriage, a 14-year-old bride is led to a bridal chamber and given instructions in nuptial customs by her sister-in-law.",
    imgUrl:
  ...
  },
  {
    ...
    cast: ["Tuncel Kurtiz", "Sabri Tutal", "Aslı Sulan", "Kemal Gültekin"],
    synopsis:
